...
define :adjustviolins do |n|
  sample n, rate: 0.68, amp: p
end

define :samplesleeps do |n|
...
live_loop :violins do
  sync :bassclef
  adjustviolins violins #calls perameterized function
  samplesleeps violins #calls perameterized function
  sleep 1
end
